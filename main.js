...
var configuration = [ 
	new Ammount("1ct", 30, 1), 
	new Ammount("2ct", 40, 2), 
	new Ammount("5ct", 50, 5),
	new Ammount("10ct", 130, 10), 
	new Ammount("20ct", 140, 20), 
	new Ammount("50ct", 70, 50),
	new Ammount("1€", 100, 100), 
	new Ammount("2€", 170, 200), 
	new Ammount("5€", 70, 500),
